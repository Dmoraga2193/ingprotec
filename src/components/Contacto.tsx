...
const ContactSection: React.FC = () => {
  ...
  const onSubmit = async (event) => {
    ...
    // Expresión regular para validar el número de teléfono (ejemplo para Chile)
    const telefonoRegex = /^[+]*[(]?[0-9]{1,4}[)]?[-\s./0-9]*$/;
    ...
    formData.append("access_key", "7d6257d5-2136-4a00-81a7-9a01cb15f620");
